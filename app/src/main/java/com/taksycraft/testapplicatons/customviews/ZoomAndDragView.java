...
public class ZoomAndDragView extends RelativeLayout implements View.OnTouchListener, GestureDetector.OnGestureListener, ScaleGestureDetector.OnScaleGestureListener {
    ...
    public ZoomAndDragView(Context context) {
    ...
    public ZoomAndDragView(Context context, AttributeSet attrs) {
        // Implement the Parent.
        super(context, attrs);
        // Initialize Member Variables.
        this.mGestureDetector      = new GestureDetector(context, this);
    ...
    public ZoomAndDragView(Context context , AttributeSet attrs, int defStyleAttr) {
        // Implement the Parent.
    ...
    public ZoomAndDragView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        // Implement the Parent.
