...
public class ArcShapedView extends View {
    ...
    private float centerRadiusRatio = 0.3F;
    ...
    public ArcShapedView(Context context){
        this(context, null);
    }

    public ArcShapedView(Context context, AttributeSet attrs){
        this(context, attrs, 0);
    }

    public ArcShapedView(Context context, AttributeSet attrs, int defStyle){
    ...
    public void onSizeChanged(int w, int h, int oldw, int oldh){
        ...
        mCenterRadius = mOuterRadius * centerRadiusRatio;

        outerRadiusSquare = mOuterRadius * mOuterRadius;
        innerRadiusSquare = mInnerRadius * mInnerRadius;
//        centerRadiusSquare = mInnerRadius * mInnerRadius;
            ...
            case MotionEvent.ACTION_UP:
                ...
                if(mPressed){
                    ...
                    if(distanceSquare > innerRadiusSquare && distanceSquare < outerRadiusSquare){
                        ...
                        mOnSliceClickListener.onSlickClick(-1);
                    }
                }
                break;
        }
